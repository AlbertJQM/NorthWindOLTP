...
### Integrantes
*	FERNANDEZ QUISPE LUIS FERNANDO
*	QUISBERT MUJICA ALBERT JHONATAN
*	TOLEDO LUNA CHRISTOFER
...
El modelo de datos se utiliza con fines académicos, apoyando el aprendizaje de diseño, consultas, procedimientos almacenados y optimización en sistemas de gestión de bases de datos relacionales. Asimismo, proporciona un entorno para la simulación de escenarios reales de operación empresarial.